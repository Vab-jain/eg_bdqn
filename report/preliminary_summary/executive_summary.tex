...
\vspace{1em}
\noindent\textit{Note: For more detailed analysis, empirical results, and theoretical diagnostics, please refer to the accompanying preliminary findings report.}
